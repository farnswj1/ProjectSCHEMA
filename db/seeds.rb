...
#Courses (12 entries)
csc220_01 = Course.create(course_id: 'CSC220-01', course_title: 'Computational Problem Solving',           user_id: 2, minimum_seats: 12, maximum_seats: 25, description: 'Students will learn the basics of computer science.')
csc220_02 = Course.create(course_id: 'CSC220-02', course_title: 'Computational Problem Solving',           user_id: 2, minimum_seats: 12, maximum_seats: 25, description: 'Students will learn the basics of computer science.')
csc230_01 = Course.create(course_id: 'CSC230-01', course_title: 'Data Structures',                         user_id: 5, minimum_seats: 12, maximum_seats: 18, description: 'Students will learn various data structures.')
csc270_01 = Course.create(course_id: 'CSC270-01', course_title: 'Discrete Structures',                     user_id: 6, minimum_seats: 12, maximum_seats: 20, description: 'Students will learn about discrete structures, including finite state machines.')
csc315_01 = Course.create(course_id: 'CSC315-01', course_title: 'Database Systems',                        user_id: 3, minimum_seats: 10, maximum_seats: 18, description: 'Students will learn about database management systems.')
csc325_01 = Course.create(course_id: 'CSC325-01', course_title: 'Computer Architecture',                   user_id: 3, minimum_seats: 10, maximum_seats: 18, description: 'Students will learn about computer architecture.')
csc345_01 = Course.create(course_id: 'CSC345-01', course_title: 'Operating Systems',                       user_id: 7, minimum_seats: 10, maximum_seats: 18, description: 'Students will learn everything about operating systems.')
csc380_01 = Course.create(course_id: 'CSC380-01', course_title: 'Artificial Intelligence',                 user_id: 2, minimum_seats: 10, maximum_seats: 18, description: 'Students will learn about AIs.')
csc415_01 = Course.create(course_id: 'CSC415-01', course_title: 'Software Engineering',                    user_id: 6, minimum_seats:  8, maximum_seats: 18, description: 'Students will learn how to develop quality software.')
csc415_02 = Course.create(course_id: 'CSC415-02', course_title: 'Software Engineering',                    user_id: 6, minimum_seats:  8, maximum_seats: 17, description: 'Students will learn how to develop quality software.')
csc445_01 = Course.create(course_id: 'CSC445-01', course_title: 'Theory of Computation',                   user_id: 7, minimum_seats:  6, maximum_seats: 10, description: 'Students will learn computational techniques.')
